...
//            NestedQueryBuilder author = QueryBuilders.nestedQuery("author", QueryBuilders.termQuery("author.name", searchScrollAfterArticleParam.getName()), ScoreMode.Avg);
//            queryBuilder.must(author);
//        }
//        if (!StringUtils.isEmpty(searchScrollAfterArticleParam.getAge())) {
//            NestedQueryBuilder author = QueryBuilders.nestedQuery("author", QueryBuilders.termQuery("author.age", searchScrollAfterArticleParam.getAge()), ScoreMode.Avg);
//            queryBuilder.must(author);
//        }
